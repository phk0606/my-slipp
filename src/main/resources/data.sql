insert into user (id, user_id, password, name, email, create_date) values (1, 'javajigi', '2222','자바지기', 'abc@abc.com', current_timestamp());
insert into user (id, user_id, password, name, email, create_date) values (2, 'sanjigi', '2222','산지기', 'sanjigi@abc.com', current_timestamp());
